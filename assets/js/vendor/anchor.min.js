    ...
    return function(A) {
        function e(A) {
            (A.icon = A.hasOwnProperty("icon") ? A.icon : ""),
                ...
                (A.placement = A.hasOwnProperty("placement")
                    ? A.placement
                    : "right"),
                (A.ariaLabel = A.hasOwnProperty("ariaLabel")
                    ? A.ariaLabel
                    : "Anchor"),
        ...
        (this.options = A || {}),
            ...
            (this.add = function(A) {
                ...
                if (
                    (e(this.options),
                    "touch" === (f = this.options.visible) &&
                        (f = this.isTouchDevice() ? "always" : "hover"),
                    A || (A = "h2, h3, h4, h5, h6"),
                    0 === (n = t(A)).length)
                )
                    return this;
                for (
                    ...
                    if (this.hasAnchorJSLink(n[r])) p.push(r);
                    else {
                        ...
                        a.replace(/-/g, " "),
                            ((d = document.createElement("a")).className =
                ...
                for (r = 0; r < p.length; r++) n.splice(p[r] - r, 1);
                return (this.elements = this.elements.concat(n)), this;
            }),
            (this.remove = function(A) {
                for (var e, i, n = t(A), o = 0; o < n.length; o++)
                    (i = n[o].querySelector(".anchorjs-link")) &&
                        (-1 !== (e = this.elements.indexOf(n[o])) &&
