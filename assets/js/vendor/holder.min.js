                ...
                (function(t) {
                    ...
                    function s(e) {
                        ...
                        if (e.flags.autoFg) {
                            ...
                            c = d
                                .blendAlpha(d.lighterThan("7f7f7f") ? p : f)
                                .toHex(!0);
                        }
                        ...
                        if (m.lineCount > 1) {
                            ...
                            if (
                                ...
                                for (b in g.children)
                                    (w = g.children[b]),
                                        w.moveTo(e.width - w.width, null, null);
                            ...
                            g.moveTo(null, (e.height - g.height) / 2, null),
                                (e.height - g.height) / 2 < 0 &&
                                    g.moveTo(null, 0, null);
                        } else
                            (v = new s.Text(e.text)),
                                (w = new s.Group("line0")),
                                w.add(v),
                                ...
                                "left" === e.align
                                    ...
                                    ? g.moveTo(0 - (e.width - i), null, null)
                                    : g.moveTo(
                                          (e.width - m.boundingBox.width) / 2,
                                          null,
                                          null
                                      ),
                                g.moveTo(
                                    null,
                                    (e.height - m.boundingBox.height) / 2,
                                    null
                                );
                        return a;
                    }
                    ...
                    function f(e) {
                        e.holderData.invisibleId ||
                            ...
                            (O.vars.invisibleImages[
                                "i" + O.vars.invisibleId
                            ] = e),
                            (e.holderData.invisibleId = O.vars.invisibleId));
                    }
                    function p(e) {
                        O.vars.debounceTimer || e.call(this),
                            O.vars.debounceTimer &&
                                t.clearTimeout(O.vars.debounceTimer),
                                ...
                                if (O.setup.supportsSVG) {
                                    ...
                                    if (u > 1) {
                                        ...
                                        for (var v = 0; v < c.length; v++)
                                            if (0 !== c[v].length) {
                                                n.nodeValue = w.decodeHtmlEntity(
                                                    c[v]
                                                );
                                                var y = t.getBBox();
                                                m.push({
                ...
                (function(e) {
                    ...
                    (t.initSVG = function(e, t, n) {
                        ...
                        for (var h = 0; h < e.childNodes.length; h++)
                            e.childNodes[h].nodeType === o &&
                                e.removeChild(e.childNodes[h]);
                ...
                e.exports = function r(e, t, n) {
                    ...
                    for (; d < e.length; d++) {
                        ...
                        if (void 0 !== e[d] && e[d] !== !0)
                            ...
                            else if ("number" == typeof e[d])
                                e[0].children.push(e[d]);
