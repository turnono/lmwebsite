    ...
    return function(e) {
        function t(e) {
            (e.icon = e.hasOwnProperty("icon") ? e.icon : ""),
                ...
                (e.placement = e.hasOwnProperty("placement")
                    ? e.placement
                    : "right"),
                (e.ariaLabel = e.hasOwnProperty("ariaLabel")
                    ? e.ariaLabel
                    : "Anchor"),
        ...
        (this.options = e || {}),
            ...
            (this.add = function(e) {
                ...
                if (
                    (t(this.options),
                    "touch" === (A = this.options.visible) &&
                        (A = this.isTouchDevice() ? "always" : "hover"),
                    e || (e = "h2, h3, h4, h5, h6"),
                    0 === (i = n(e)).length)
                )
                    return this;
                for (
                    ...
                    if (this.hasAnchorJSLink(i[l])) p.push(l);
                    else {
                        if (i[l].hasAttribute("id"))
                            s = i[l].getAttribute("id");
                        else if (i[l].hasAttribute("data-anchor-id"))
                            s = i[l].getAttribute("data-anchor-id");
                        else {
                            (d = h = this.urlify(i[l].textContent)), (u = 0);
                            do {
                                void 0 !== c && (d = h + "-" + u),
                                    (c = a.indexOf(d)),
                                    (u += 1);
                        ...
                        s.replace(/-/g, " "),
                            ((f = document.createElement("a")).className =
                            ...
                            "left" === this.options.placement
                                ? ((f.style.position = "absolute"),
                                  ...
                                  i[l].insertBefore(f, i[l].firstChild))
                                : ((f.style.paddingLeft = "0.375em"),
                                  i[l].appendChild(f));
                    }
                for (l = 0; l < p.length; l++) i.splice(p[l] - l, 1);
                return (this.elements = this.elements.concat(i)), this;
            }),
            (this.remove = function(e) {
                for (var t, r, i = n(e), o = 0; o < i.length; o++)
                    (r = i[o].querySelector(".anchorjs-link")) &&
                        (-1 !== (t = this.elements.indexOf(i[o])) &&
            ...
            (this.hasAnchorJSLink = function(e) {
                var t =
                        e.firstChild &&
                        (" " + e.firstChild.className + " ").indexOf(
                            " anchorjs-link "
                        ) > -1,
                    n =
                        e.lastChild &&
                        (" " + e.lastChild.className + " ").indexOf(
                            " anchorjs-link "
                        ) > -1;
                return t || n || !1;
            });
                        ...
                        var c = i(t),
                            ...
                            A = (function(e) {
                                function t(e, n) {
                                    ...
                                    return (
                                        r.resolveOptions(n), r.listenClick(e), r
                                    );
                                }
                                return (
                                    s(t, e),
        ...
        return (function(e) {
            ...
            function(e, t, n) {
                (function(t) {
                    ...
                    function i(e, t) {
                        var n = {
                                theme: k(M.settings.themes.gray, null),
                        ...
                        if (
                            ...
                            if (y.truthy(l.ratio)) {
                                n.fluid = !0;
                                var c = parseFloat(
                                        n.dimensions.width.replace("%", "")
                                    ),
                                    u = parseFloat(
                                        n.dimensions.height.replace("%", "")
                                    );
                            ...
                            if (
                                ((n.auto = y.truthy(l.auto)),
                                l.bg && (n.theme.bg = y.parseColor(l.bg)),
                                l.fg && (n.theme.fg = y.parseColor(l.fg)),
                                l.bg && !l.fg && (n.autoFg = !0),
                                l.theme &&
                                    n.instanceOptions.themes.hasOwnProperty(
                                        l.theme
                                    ) &&
                                    (n.theme = k(
                                        n.instanceOptions.themes[l.theme],
                                        null
                                    )),
                                ...
                                (n.nowrap = y.truthy(l.nowrap)),
                                (n.outline = y.truthy(l.outline)),
                                y.truthy(l.random))
                            ) {
                                M.vars.cache.themeKeys =
                                    M.vars.cache.themeKeys ||
                                ...
                                var h =
                                    M.vars.cache.themeKeys[
                                        0 |
                                            (Math.random() *
                                                M.vars.cache.themeKeys.length)
                                    ];
                                n.theme = k(n.instanceOptions.themes[h], null);
                            }
                        }
                        return n;
                    }
                    function o(e) {
                        ...
                        if (
                            ...
                            for (
                                ...
                                f[A] = y.encodeHtmlEntity(f[A]);
                            s.text = f.join("\\n");
                        }
                        if (s.text) {
                            var p = s.text.match(h);
                            null !== p &&
                                p.forEach(function(e) {
                                    "holder_dimensions" === e &&
                                        (s.text = s.text.replace(e, l));
                                });
                        }
                        var g = r.holderURL,
                            m = k(i, null);
                        if (
                            (r.font &&
                                ...
                                !m.noFontFallback &&
                                    ...
                                    M.setup.supportsCanvas &&
                                    "svg" === m.renderer &&
                                    (m = k(m, { renderer: "canvas" }))),
                            r.font &&
                                "canvas" == m.renderer &&
                                (m.reRender = !0),
                            "background" == t)
                            ...
                            null == n.getAttribute("data-background-src") &&
                                w.setAttr(n, { "data-background-src": g });
                        else {
                            var v = {};
                            (v[M.vars.dataAttr] = g), w.setAttr(n, v);
                        }
                        (r.theme = s),
                            (n.holderData = { flags: r, engineSettings: m }),
                            ("image" != t && "fluid" != t) ||
                                w.setAttr(n, {
                                    alt: s.text
                                        ? d
                        ...
                        "image" == t
                            ...
                            : "fluid" == t &&
                              ...
                              "html" == m.renderer
                                  ? (n.style.backgroundColor = s.bg)
                                  : (M.vars.resizableImages.push(n), c(n)));
                    }
                    function a(e) {
                        function n() {
                            var t = null;
                        ...
                        switch (l.renderer) {
                            case "svg":
                                if (!M.setup.supportsSVG) return;
                                break;
                            case "canvas":
                                if (!M.setup.supportsCanvas) return;
                                break;
                            default:
                                return;
                        }
                    ...
                    function s(e) {
                        ...
                        var n = M.defaults.size;
                        switch (
                            (parseFloat(e.theme.size)
                                ? (n = e.theme.size)
                                : parseFloat(e.flags.size) &&
                                  (n = e.flags.size),
                            (e.font = {
                                family: e.theme.font
                                    ? e.theme.font
                                    : "Arial, Helvetica, Open Sans, sans-serif",
                                size: l(e.width, e.height, n, M.defaults.scale),
                                units: e.theme.units
                                    ? e.theme.units
                                    : M.defaults.units,
                                weight: e.theme.fontweight
                                    ? e.theme.fontweight
                                    : "bold"
                            }),
                            (e.text =
                            ...
                            (e.align =
                                e.theme.align || e.flags.align || "center"),
                            e.flags.textmode)
                        ) {
                            case "literal":
                                e.text =
                                    e.flags.dimensions.width +
                                    "x" +
                                    e.flags.dimensions.height;
                                break;
                            case "exact":
                        ...
                        var r = e.flags.lineWrap || M.setup.lineWrapRatio,
                            i = e.width * r,
                            o = i,
                            a = new v({ width: e.width, height: e.height }),
                            s = a.Shape,
                        ...
                        var h = e.theme.fg;
                        if (e.flags.autoFg) {
                            var d = new x(c.properties.fill),
                                f = new x("fff"),
                                A = new x("000", { alpha: 0.285714 });
                            h = d
                                .blendAlpha(d.lighterThan("7f7f7f") ? A : f)
                                .toHex(!0);
                        }
                        ...
                        if (g.lineCount > 1) {
                            var b,
                                ...
                                E = 0,
                                S = 0;
                            (y = new s.Group("line" + S)),
                                ("left" !== e.align && "right" !== e.align) ||
                                    (o = e.width * (1 - 2 * (1 - r)));
                            for (var C = 0; C < g.words.length; C++) {
                                var k = g.words[C];
                                m = new s.Text(k.text);
                                var T = "\\n" == k.text;
                                !e.noWrap &&
                                    (w + k.width >= o || T === !0) &&
                                    (t(p, y, w, p.properties.leading),
                                    p.add(y),
                                    (w = 0),
                            ...
                            p.moveTo(null, (e.height - p.height) / 2, null),
                                (e.height - p.height) / 2 < 0 &&
                                    p.moveTo(null, 0, null);
                        } else
                            (m = new s.Text(e.text)),
                                (y = new s.Group("line0")),
                                y.add(m),
                                ...
                                "left" === e.align
                                    ...
                                    ? p.moveTo(0 - (e.width - i), null, null)
                                    : p.moveTo(
                                          (e.width - g.boundingBox.width) / 2,
                                          null,
                                          null
                                      ),
                                p.moveTo(
                                    null,
                                    (e.height - g.boundingBox.height) / 2,
                                    null
                                );
                        return a;
                    }
                    ...
                    function c(e) {
                        var t;
                        t =
                            null == e || null == e.nodeType
                                ? M.vars.resizableImages
                                : [e];
                            ...
                            if (i.holderData) {
                                ...
                                if (s) {
                                    ...
                                    var c = {
                                        ...
                                        el: i,
                                        engineSettings:
                                            i.holderData.engineSettings
                                    };
                                    "exact" == o.textmode &&
                                        ((o.exactDimensions = s),
                                        (c.holderSettings.dimensions =
                                            o.dimensions)),
                                        a(c);
                                } else f(i);
                            }
                            ...
                            if (t) {
                                var n = e.holderData.flags,
                                    r = {
                                        fluidHeight:
                                            "%" ==
                                            n.dimensions.height.slice(-1),
                                        fluidWidth:
                                            "%" == n.dimensions.width.slice(-1),
                                        mode: null,
                                        initialDimensions: t
                                    };
                    ...
                    function h() {
                        var e,
                            n = [],
                            r = Object.keys(M.vars.invisibleImages);
                        r.forEach(function(t) {
                            (e = M.vars.invisibleImages[t]),
                                T(e) &&
                                    "img" == e.nodeName.toLowerCase() &&
                                    (n.push(e),
                                    delete M.vars.invisibleImages[t]);
                        }),
                    ...
                    function d() {
                        M.vars.visibilityCheckStarted ||
                            (t.requestAnimationFrame(h),
                            (M.vars.visibilityCheckStarted = !0));
                    }
                    function f(e) {
                        e.holderData.invisibleId ||
                            ((M.vars.invisibleId += 1),
                            (M.vars.invisibleImages[
                                "i" + M.vars.invisibleId
                            ] = e),
                            (e.holderData.invisibleId = M.vars.invisibleId));
                    }
                    function A(e) {
                        M.vars.debounceTimer || e.call(this),
                            M.vars.debounceTimer &&
                                t.clearTimeout(M.vars.debounceTimer),
                            (M.vars.debounceTimer = t.setTimeout(function() {
                                (M.vars.debounceTimer = null), e.call(this);
                            }, M.setup.debounce));
                    }
                    function p() {
                        A(function() {
                        ...
                        O = {
                            ...
                            addTheme: function(e, t) {
                                return (
                                    null != e &&
                                        null != t &&
                                        (M.settings.themes[e] = t),
                                    delete M.vars.cache.themeKeys,
                                    this
                                );
                            },
                            addImage: function(e, t) {
                                var n = w.getNodeArray(t);
                                return (
                                    n.forEach(function(t) {
                                        var n = w.newEl("img"),
                                            r = {};
                                        (r[M.setup.dataAttr] = e),
                                            w.setAttr(n, r),
                                            t.appendChild(n);
                                    }),
                                    this
                            ...
                            run: function(e) {
                                ...
                                (M.vars.preempted = !0),
                                    (M.vars.dataAttr =
                                        a.dataAttr || M.setup.dataAttr),
                                    (n.renderer = a.renderer
                                        ? a.renderer
                                        : M.setup.renderer),
                                    M.setup.renderers
                                        .join(",")
                                        .indexOf(n.renderer) === -1 &&
                                        (n.renderer = M.setup.supportsSVG
                                            ? "svg"
                                            : M.setup.supportsCanvas
                                            ? "canvas"
                                            : "html");
                                        ...
                                        if (t.getComputedStyle) {
                                            ...
                                            if (0 === h) c = l;
                                                ...
                                                if (null !== d) c = d[1];
                                                    ...
                                                    throw "Holder: unable to parse background URL: " +
                                                        l;
                                            }
                                            if (c) {
                                                var f = i(c, a);
                                    ...
                                    u.forEach(function(e) {
                                        ...
                                        try {
                                            (t.data = e.getAttribute("data")),
                                                (t.dataSrc = e.getAttribute(
                                                    M.vars.dataAttr
                                                ));
                                        } catch (e) {}
                                        var i =
                                                null != t.data &&
                                                0 === t.data.indexOf(a.domain),
                                            o =
                                                null != t.dataSrc &&
                                                0 ===
                                                    t.dataSrc.indexOf(a.domain);
                                        i
                                            ? r(a, n, t.data, e)
                                            : o && r(a, n, t.dataSrc, e);
                                    }),
                        ...
                        D = (function() {
                            ...
                            return function(r) {
                                ...
                                if (M.setup.supportsSVG) {
                                    ...
                                    var c = t.getBBox(),
                                        u = Math.ceil(
                                            c.width / i.properties.width
                                        ),
                                        h = l.text.split(" "),
                                        d = l.text.match(/\\n/g);
                                    (u += null == d ? 0 : d.length),
                                        (n.nodeValue = l.text.replace(
                                            /[ ]+/g,
                                            ""
                                        ));
                                    ...
                                    if (u > 1) {
                                        ...
                                        for (var m = 0; m < h.length; m++)
                                            if (0 !== h[m].length) {
                                                n.nodeValue = y.decodeHtmlEntity(
                                                    h[m]
                                                );
                                                var v = t.getBBox();
                                                g.push({
                    ...
                    for (var F in M.flags)
                        M.flags.hasOwnProperty(F) &&
                            (M.flags[F].match = function(e) {
                    ...
                    (M.setup = {
                        ...
                        (function() {
                            var e = w.newEl("canvas");
                            e.getContext &&
                                e
                                    .toDataURL("image/png")
                                    .indexOf("data:image/png") != -1 &&
                                ((M.setup.renderer = "canvas"),
                                (M.setup.supportsCanvas = !0)),
                                document.createElementNS &&
                                    document.createElementNS(j, "svg")
                                        .createSVGRect &&
                                    ((M.setup.renderer = "svg"),
                                    (M.setup.supportsSVG = !0));
                        })(),
                        d(),
                        g &&
                            g(function() {
                                M.vars.preempted || O.run(),
                                    t.addEventListener
                                        ? (t.addEventListener("resize", p, !1),
                                          t.addEventListener(
                                              "orientationchange",
                                              p,
                                              !1
                                          ))
                                        : t.attachEvent("onresize", p),
            ...
            function(e, t) {
                var n = function(e) {
                    ...
                    var c = new i();
                    return (
                        (this.Shape = { Rect: s, Text: l, Group: a }),
                        (this.root = c),
                        this
                    );
                };
                    ...
                    (t.initSVG = function(e, t, n) {
                        ...
                        e && e.querySelector
                            ...
                            e.webkitMatchesSelector &&
                                e.setAttribute("xmlns", i);
                        for (var c = 0; c < e.childNodes.length; c++)
                            e.childNodes[c].nodeType === o &&
                        ...
                        (t.serializeSVG = function(t, n) {
                            if (e.XMLSerializer) {
                                ...
                                if (n.svgXMLStylesheet) {
                                    for (
                                        var s = r.createXML(), l = a.length - 1;
                                        l >= 0;
                                        l--
                                    ) {
            ...
            function(e, t) {
                ...
                (n.rgb2hex = function(e, t, n) {
                    ...
                    (n.prototype.lighten = function(e) {
                        var t =
                                Math.min(1, Math.max(0, Math.abs(e))) *
                                (e < 0 ? -1 : 1),
                            r = (255 * t) | 0,
                ...
                e.exports = function(e, t) {
                    var n = t.engineSettings,
                        ...
                        c = l
                            .map(function(e) {
                                return (
                                    '<?xml-stylesheet rel="stylesheet" href="' +
                                    e +
                                    '"?>'
                                );
                            })
                    ...
                    var x = h.element({ tag: "g", id: d, content: w }),
                        ...
                        S = h.element({ tag: "defs", content: E }),
                        C = h.element({
                            tag: "svg",
                            content: [S, x],
                    ...
                    for (; d < t.length; d++) {
                        ...
                        if (void 0 !== t[d] && t[d] !== !0)
                            if ("string" == typeof t[d])
                                ...
                                e(t[d], n, r),
                                    t[d][0] && t[0].children.push(t[d][0]);
                            } else if ("function" == typeof t[d]) u = t[d];
                            else {
                                ...
                                for (c in t[d])
                                    t[d].hasOwnProperty(c) &&
                                        null !== t[d][c] &&
                                        t[d][c] !== !1 &&
                                        ("style" === c &&
                                        "object" == typeof t[d][c]
                                            ? (t[0].attr[c] = JSON.stringify(
                                                  t[d][c],
                                                  o
                                              )
                                                  .slice(2, -2)
                ...
                e.exports = (function() {
                    ...
                    return function(n) {
                        ...
                        (t.font =
                            ...
                            " " +
                            r * h.properties.font.size +
                            h.properties.font.units +
                            " " +
                            h.properties.font.family +
                            ", monospace"),
                            (t.fillStyle = h.properties.fill);
                                ...
                                var p = f.children[A],
                                    ...
                                    m =
                                        ...
                                        (h.y +
                                            f.y +
                                            p.y +
                                            h.properties.leading / 2);
                                t.fillText(p.properties.text, g, m);
                            }
                        }
