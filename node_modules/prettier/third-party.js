            ...
            get: function get() {
                ...
                for (var key in properties) {
                    ...
                    if ("message" in modifier) {
                        newMessage =
                            modifier.message(this[key], newMessage) ||
                            newMessage;
...
function loadDocuments(input, options) {
    ...
    while (
        state.input.charCodeAt(state.position) === 0x20
        /* Space */
    ) {
        state.lineIndent += 1;
        state.position += 1;
...
function getDirectory(filepath) {
    return new Promise(function(resolve, reject) {
        return isDirectory_1(filepath, function(err, filepathIsDirectory) {
            ...
            return resolve(
                filepathIsDirectory ? filepath : path.dirname(filepath)
            );
        });
    });
}
        ...
        _createClass(Explorer, [
            ...
            },
            {
                ...
                value: function searchFromDirectory(dir) {
                    ...
                    var run = function run() {
                        return _this2
                            .searchDirectory(absoluteDir)
                            .then(function(result) {
                                var nextDir = _this2.nextDirectoryToSearch(
                                    absoluteDir,
                                    result
                                );
            ...
            },
            {
                ...
                value: function searchFromDirectorySync(dir) {
                    ...
                    var run = function run() {
                        ...
                        var nextDir = _this3.nextDirectoryToSearch(
                            absoluteDir,
                            result
                        );
            ...
            },
            {
                ...
                value: function searchDirectory(dir) {
                    ...
                    return this.config.searchPlaces.reduce(function(
                        prevResultPromise,
                        place
                    ) {
            ...
            },
            {
                ...
                value: function searchDirectorySync(dir) {
                    ...
                    try {
                        for (
                            var _iterator = this.config.searchPlaces[
                                    Symbol.iterator
                                ](),
                                _step;
            ...
            },
            {
                ...
                value: function loadSearchPlace(dir, place) {
                    ...
                    return readFile_1(filepath).then(function(content) {
                        return _this5.createCosmiconfigResult(
                            filepath,
                            content
                        );
                    });
            ...
            },
            {
                ...
                value: function nextDirectoryToSearch(
                    currentDir,
                    currentResult
                ) {
                    ...
                    if (
                        nextDir === currentDir ||
                        currentDir === this.config.stopDir
                    ) {
                        return null;
                    }
            ...
            },
            {
                ...
                value: function loadPackageProp(filepath, content) {
                    ...
                    var packagePropValue = getPropertyByPath_1(
                        parsedContent,
            ...
            },
            {
                ...
                value: function getSyncLoaderForFile(filepath) {
                    ...
                    if (!entry.sync) {
                        throw new Error(
                            `No sync loader specified for ${getExtensionDescription(
                                filepath
                            )}`
                        );
                    }
            ...
            },
            {
                ...
                value: function getAsyncLoaderForFile(filepath) {
                    ...
                    if (!loader) {
                        throw new Error(
                            `No async loader specified for ${getExtensionDescription(
                                filepath
                            )}`
                        );
                    }
            ...
            },
            {
                ...
                value: function loadedContentToCosmiconfigResult(
                    filepath,
                    loadedContent
                ) {
                ...
                value: function createCosmiconfigResult(filepath, content) {
                    ...
                    return Promise.resolve()
                        ...
                        .then(function(loaderResult) {
                            return _this6.loadedContentToCosmiconfigResult(
                                filepath,
                                loaderResult
                            );
                        });
            ...
            },
            {
                ...
                value: function createCosmiconfigResultSync(filepath, content) {
                    var loaderResult = this.loadFileContent(
                        "sync",
                        filepath,
                        content
                    );
            ...
            },
            {
                ...
                value: function validateFilePath(filepath) {
                    if (!filepath) {
                        throw new Error(
                            "load and loadSync must pass a non-empty string"
                        );
                    }
                }
            },
                            ...
                            function() {
                                return readFile_1(absoluteFilePath, {
                                    ...
                                    .then(function(content) {
                                        return _this7.createCosmiconfigResult(
                                            absoluteFilePath,
                                            content
                                        );
                                    })
                ...
                value: function loadSync(filepath) {
                    ...
                    return cacheWrapper_1(
                        ...
                        function() {
                            ...
                            var result = _this8.createCosmiconfigResultSync(
                                absoluteFilePath,
                                content
                            );
...
var isFS = function isFS(stream) {
    ...
    return (
        (stream instanceof (fs.ReadStream || noop$1) ||
            stream instanceof (fs.WriteStream || noop$1)) &&
        isFn(stream.close)
    );
};
...
var pump = function pump() {
    ...
    var callback =
        (isFn(streams[streams.length - 1] || noop$1) && streams.pop()) ||
        noop$1;
    ...
    (function(_Error) {
        ...
        function MaxBufferError() {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(MaxBufferError).call(this, "maxBuffer exceeded")
            );
            ...
            switch (typeof vendor.pr) {
                ...
                case "object":
                    if ("env" in vendor.pr) {
                        ...
                        exports.isPR =
                            vendor.pr.env in env &&
                            env[vendor.pr.env] !== vendor.pr.ne;
