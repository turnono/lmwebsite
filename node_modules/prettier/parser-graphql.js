!(function(e, n) {
    ...
    var h = o(function(e, n) {
        ...
        var t,
            i = (t = f) && t.__esModule ? t : { default: t };
    });
    r(h);
    ...
    var y = o(function(e, n) {
        function t(e) {
            for (var n = null, t = 1; t < e.length; t++) {
                var r = e[t],
                    o = i(r);
                if (o !== r.length && (null === n || o < n) && 0 === (n = o))
                    break;
            }
            return null === n ? 0 : n;
        }
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.dedentBlockStringValue = function(e) {
                var n = e.split(/\r\n|[\n\r]/g),
                    i = t(n);
                if (0 !== i)
                    for (var o = 1; o < n.length; o++) n[o] = n[o].slice(i);
    ...
    var N = o(function(e, n) {
            ...
            var t = e.source,
                ...
                s = (function(e, n, t) {
                    ...
                    for (; r < i; ) {
                        ...
                        if (9 === o || 32 === o || 44 === o || 65279 === o) ++r;
                        else if (10 === o) ++r, ++t.line, (t.lineStart = r);
                        else {
                            if (13 !== o) break;
            ...
            switch (f) {
                ...
                case 46:
                    if (
                        ...
                        return new o(p.TokenKind.SPREAD, s, s + 3, l, d, n);
                    break;
                case 58:
                ...
                case 57:
                    return (function(e, n, t, i, r, s) {
                        ...
                        return new o(
                            f ? p.TokenKind.FLOAT : p.TokenKind.INT,
                            n,
                            d,
                            i,
                            r,
                ...
                case 34:
                    return 34 === i.charCodeAt(s + 1) &&
                        ...
                        ? (function(e, n, t, i, r, s) {
                              ...
                              for (
                                  ;
                                  u < c.length && !isNaN((d = c.charCodeAt(u)));
                                  ...
                                  if (
                                      ...
                                      return (
                                          (f += c.slice(l, u)),
                                          new o(
                                              p.TokenKind.BLOCK_STRING,
                                              n,
                                              u + 3,
                                              t,
                                              i,
                                              r,
                                              (0, y.dedentBlockStringValue)(f)
                                          )
                                      );
        ...
        function c(e, n, t) {
            ...
            throw (0,
            E.syntaxError)(e, r, "Invalid number, expected digit but got: ".concat(a(o), "."));
        }
        function u(e) {
            return e >= 48 && e <= 57
                ? e - 48
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }),
            ...
            (n.isPunctuatorToken = function(e) {
                ...
                return (
                    n === p.TokenKind.BANG ||
                    n === p.TokenKind.DOLLAR ||
                    n === p.TokenKind.AMP ||
                    n === p.TokenKind.PAREN_L ||
                    n === p.TokenKind.PAREN_R ||
                    n === p.TokenKind.SPREAD ||
                    n === p.TokenKind.COLON ||
                    n === p.TokenKind.EQUALS ||
                    n === p.TokenKind.AT ||
                    n === p.TokenKind.BRACKET_L ||
                    n === p.TokenKind.BRACKET_R ||
                    n === p.TokenKind.BRACE_L ||
                    n === p.TokenKind.PIPE ||
                    n === p.TokenKind.BRACE_R
                );
            }),
            (0, ((t = h) && t.__esModule ? t : { default: t }).default)(
                o,
                function() {
                    return {
                        kind: this.kind,
    ...
    var m = o(function(e, t) {
        ...
        var i,
            r = (i = f) && i.__esModule ? i : { default: i };
        function o(e) {
            return (o =
                "function" == typeof Symbol && "symbol" === n(Symbol.iterator)
                    ? function(e) {
                    ...
                    return null === e
                        ...
                        : (function(e, n) {
                              ...
                              if (void 0 !== i) {
                                  var o = i.call(e);
                                  if (o !== e)
                                      return "string" == typeof o ? o : c(o, t);
                              } else if (Array.isArray(e))
                                  return (function(e, n) {
                                      if (0 === e.length) return "[]";
                                      if (n.length > s) return "[Array]";
                                      for (
                                          var t = Math.min(a, e.length),
                                              i = e.length - t,
                                              r = [],
                                              o = 0;
                                          o < t;
            ...
            return (
                ...
                (n.parseDefinition = function() {
                    if (this.peek(p.TokenKind.NAME))
                        ...
                        if (this.peek(p.TokenKind.BRACE_L))
                            return this.parseOperationDefinition();
                ...
                (n.parseOperationDefinition = function() {
                    ...
                    return (
                        this.peek(p.TokenKind.NAME) && (n = this.parseName()),
                        {
                            kind: d.Kind.OPERATION_DEFINITION,
                            operation: t,
                            name: n,
                ...
                (n.parseVariable = function() {
                    var e = this._lexer.token;
                    return (
                        this.expectToken(p.TokenKind.DOLLAR),
                        {
                ...
                (n.parseSelection = function() {
                    return this.peek(p.TokenKind.SPREAD)
                        ? this.parseFragment()
                        : this.parseField();
                }),
                (n.parseField = function() {
                    var e,
                        ...
                        i = this.parseName();
                    return (
                        this.expectOptionalToken(p.TokenKind.COLON)
                            ...
                            : (n = i),
                        {
                            ...
                            directives: this.parseDirectives(!1),
                            selectionSet: this.peek(p.TokenKind.BRACE_L)
                    ...
                    switch (n.kind) {
                        ...
                        case p.TokenKind.NAME:
                            return "true" === n.value || "false" === n.value
                                ...
                                : "null" === n.value
                                ? (this._lexer.advance(),
                                  { kind: d.Kind.NULL, loc: this.loc(n) })
                                : (this._lexer.advance(),
                                  {
                                      kind: d.Kind.ENUM,
                                      value: n.value,
                ...
                (n.parseDirective = function(e) {
                    var n = this._lexer.token;
                    return (
                        this.expectToken(p.TokenKind.AT),
                        {
                ...
                (n.parseTypeReference = function() {
                    var e,
                        n = this._lexer.token;
                    return (
                        this.expectOptionalToken(p.TokenKind.BRACKET_L)
                            ? ((e = this.parseTypeReference()),
                              this.expectToken(p.TokenKind.BRACKET_R),
                              (e = {
                        ...
                        this.expectOptionalToken(p.TokenKind.BANG)
                            ? {
                ...
                (n.peekDescription = function() {
                    return (
                        this.peek(p.TokenKind.STRING) ||
                        this.peek(p.TokenKind.BLOCK_STRING)
                    );
                }),
                ...
                (n.parseFieldsDefinition = function() {
                    return this._options.allowLegacySDLEmptyFields &&
                        this.peek(p.TokenKind.BRACE_L) &&
                        this._lexer.lookahead().kind === p.TokenKind.BRACE_R
                ...
                (n.expectToken = function(e) {
                    ...
                    throw (0, E.syntaxError)(
                        this._lexer.source,
                        n.start,
                        "Expected ".concat(e, ", found ").concat(l(n))
                    );
                }),
                ...
                (n.expectKeyword = function(e) {
                    var n = this._lexer.token;
                    if (n.kind !== p.TokenKind.NAME || n.value !== e)
                        throw (0, E.syntaxError)(
                            this._lexer.source,
                            n.start,
                            'Expected "'.concat(e, '", found ').concat(l(n))
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.visit = function(e, n) {
                ...
                do {
                    ...
                    if (N) {
                        if (
                            ((h = 0 === E.length ? void 0 : v[v.length - 1]),
                            (f = T),
                            (T = E.pop()),
                            m)
                        ) {
                    ...
                    if (!Array.isArray(f)) {
                        if (!a(f))
                            throw new Error(
                                "Invalid AST Node: " + (0, i.default)(f)
                            );
                        var S = s(n, f.kind, N);
                        if (S) {
    ...
    var D = o(function(e, n) {
        function t(e) {
            return (
                e.kind === d.Kind.OPERATION_DEFINITION ||
                e.kind === d.Kind.FRAGMENT_DEFINITION
            );
        }
        function i(e) {
            return (
                e.kind === d.Kind.SCHEMA_DEFINITION ||
                r(e) ||
                e.kind === d.Kind.DIRECTIVE_DEFINITION
            );
        }
        function r(e) {
            return (
                e.kind === d.Kind.SCALAR_TYPE_DEFINITION ||
                e.kind === d.Kind.OBJECT_TYPE_DEFINITION ||
                e.kind === d.Kind.INTERFACE_TYPE_DEFINITION ||
                e.kind === d.Kind.UNION_TYPE_DEFINITION ||
                e.kind === d.Kind.ENUM_TYPE_DEFINITION ||
                e.kind === d.Kind.INPUT_OBJECT_TYPE_DEFINITION
            );
        }
        function o(e) {
        ...
        function a(e) {
            return (
                e.kind === d.Kind.SCALAR_TYPE_EXTENSION ||
                e.kind === d.Kind.OBJECT_TYPE_EXTENSION ||
                e.kind === d.Kind.INTERFACE_TYPE_EXTENSION ||
                e.kind === d.Kind.UNION_TYPE_EXTENSION ||
                e.kind === d.Kind.ENUM_TYPE_EXTENSION ||
                e.kind === d.Kind.INPUT_OBJECT_TYPE_EXTENSION
            );
        }
        Object.defineProperty(n, "__esModule", { value: !0 }),
            ...
            (n.isSelectionNode = function(e) {
                return (
                    ...
                    e.kind === d.Kind.INLINE_FRAGMENT
                );
            }),
            (n.isValueNode = function(e) {
                return (
                    e.kind === d.Kind.VARIABLE ||
                    e.kind === d.Kind.INT ||
                    e.kind === d.Kind.FLOAT ||
                    e.kind === d.Kind.STRING ||
                    e.kind === d.Kind.BOOLEAN ||
                    e.kind === d.Kind.NULL ||
                    e.kind === d.Kind.ENUM ||
                    e.kind === d.Kind.LIST ||
                    e.kind === d.Kind.OBJECT
                );
            }),
            (n.isTypeNode = function(e) {
                return (
                    e.kind === d.Kind.NAMED_TYPE ||
                    e.kind === d.Kind.LIST_TYPE ||
                    e.kind === d.Kind.NON_NULL_TYPE
                );
            }),
    ...
    r(D);
    D.isDefinitionNode,
        D.isExecutableDefinitionNode,
        D.isSelectionNode,
        D.isValueNode,
        D.isTypeNode,
        D.isTypeSystemDefinitionNode,
        D.isTypeDefinitionNode,
        D.isTypeSystemExtensionNode,
        D.isTypeExtensionNode;
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.formatError = function(e) {
                ...
                var n = e.message || "An unknown error occurred.",
                    ...
                    o = e.extensions;
                return o
                    ? { message: n, locations: t, path: r, extensions: o }
                    : { message: n, locations: t, path: r };
            });
        var t,
                        ...
                        try {
                            var r = (function(e, n) {
                                ...
                                try {
                                    ...
                                    return (
                                        (t.allowLegacySDLImplementsInterfaces = !0),
                                        e(n, t)
                                    );
                                }
                            })(i.parse, e);
                            return (
                                ...
                                (function e(t) {
                                    if (t && "object" === n(t))
                                        for (var i in (delete t.startToken,
                                        delete t.endToken,
                                        delete t.prev,
                                        delete t.next,
                                        t))
                            ...
                            throw e instanceof b.GraphQLError
                                ? t(e.message, {
                                      start: {
