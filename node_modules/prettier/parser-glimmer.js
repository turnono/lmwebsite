!(function(t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(["exports"], e)
        : e(
              (((t = t || self).prettierPlugins = t.prettierPlugins || {}),
              (t.prettierPlugins.glimmer = {}))
          );
})(this, function(t) {
    "use strict";
    var e = function(t, e) {
    ...
    var g =
        ...
        v =
            (g.now || g.mozNow || g.msNow || g.oNow || g.webkitNow,
            Object.freeze([]),
            new ((function() {
                function t(e, r) {
                    a(this, t), (this._head = e), (this._tail = r);
                }
                return (
                    i(t, [
                        {
    ...
    function S(t) {
        return Array.isArray(t) && 2 === t.length && "loc" === t[0];
    }
    function w(t) {
        ...
        var e,
            ...
            n,
            i = (function(t) {
                return "string" == typeof t ? _(t) : _(t[1], t[2] && t[2][1]);
            })(t[0]),
            o = null,
            s = t.slice(1),
            l = s.shift();
        return (
            ...
            Array.isArray(n) &&
                ...
                ((e = l),
                (function(t) {
                    return !("object" !== r(t) || !t || Array.isArray(t));
                })((l = s.shift())) &&
                    (a = (function(t, e) {
                        var r = [];
                        return (
    ...
    function P(t, e, r) {
        return { type: "AttrNode", name: t, value: e, loc: O(r || null) };
    }
    function A(t, e) {
        return { type: "TextNode", chars: t || "", loc: O(e || null) };
    }
    function _(t, e) {
    ...
    function T(t, e, r) {
        return { type: t, value: e, original: e, loc: O(r || null) };
    }
    function N(t, e) {
        return { type: "Hash", pairs: t || [], loc: O(e || null) };
    }
    function L(t, e, r) {
        return { type: "HashPair", key: t, value: e, loc: O(r || null) };
    }
    function C(t) {
        return t || null;
    }
    ...
    function O() {
        ...
        if (1 === e.length) {
            ...
            return n && "object" === r(n)
                ? {
                      source: C(n.source),
                      start: D(n.start.line, n.start.column),
                      end: D(n.end.line, n.end.column)
                  }
                : q;
        }
        var i = e[0],
            ...
            s = e[2],
            l = e[3];
        return { source: C(e[4]), start: D(i, o), end: D(s, l) };
    }
    var I = {
        ...
        block: function(t, e, r, a, n, i) {
            var o, s;
            return (
                (o = "Template" === a.type ? b({}, a, { type: "Block" }) : a),
                (s =
                    null != n && "Template" === n.type
                        ? b({}, n, { type: "Block" })
                        : n),
                {
                    type: "BlockStatement",
        ...
        comment: function(t, e) {
            return { type: "CommentStatement", value: t, loc: O(e || null) };
        },
        ...
        element: function(t, e) {
            ...
            return (
                "object" === r(t)
                    ? ((d = t.selfClosing), (t = t.name))
                    : "/" === t.slice(-1) && ((t = t.slice(0, -1)), (d = !0)),
                {
                    type: "ElementNode",
                    tag: t || "",
                    selfClosing: d,
        ...
        blockItself: function(t, e) {
            return {
                ...
                chained:
                    ...
                    void 0 !== arguments[2] &&
                    arguments[2],
                loc: O((arguments.length > 3 ? arguments[3] : void 0) || null)
            };
        },
        ...
        undefined: (function(t) {
            ...
            return T("UndefinedLiteral", void 0);
        }),
        null: function() {
        ...
        var e = (function(t) {
            ...
            if (-1 !== n && e > n && "|" === r[n + 1].charAt(0)) {
                ...
                if (
                    ...
                    throw new R(
                        "Invalid block parameters syntax: '" + i + "'",
                        t.loc
                    );
                for (var o = [], s = n + 1; s < e; s++) {
                    var l = r[s].replace(/\|/g, "");
                    if ("" !== l) {
                        if (V.test(l))
                            throw new R(
                                "Invalid identifier for block parameters: '" +
                                    l +
                                    "' in '" +
                                    i +
                                    "'",
                ...
                if (0 === o.length)
                    throw new R(
                        "Cannot use zero block parameters: '" + i + "'",
                        t.loc
                    );
                return (t.attributes = t.attributes.slice(0, n)), o;
            }
            return null;
        })(t);
        e && (t.blockParams = e);
    ...
    function U(t) {
        return "UndefinedLiteral" === t.type
            ? "undefined"
                ...
                i(e, [
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            ...
                            (this.cursorCount = 0),
                                (e = this.isTopLevel
                                    ? I.template(r, t.blockParams, t.loc)
                                    : I.blockItself(
                                          r,
                                          t.blockParams,
                                          t.chained,
                            ...
                            var a,
                                n = t.body.length;
                            if ((this.elementStack.push(e), 0 === n))
                                return this.elementStack.pop();
                            for (a = 0; a < n; a++) this.acceptNode(t.body[a]);
                            var i = this.elementStack.pop();
                            if (i !== e) {
                                var o = i;
                                throw new R(
                                    "Unclosed element `" +
                                ...
                                "in-element" === r.original &&
                                    (n = (function(t, e, r) {
                                        ...
                                        e.pairs.forEach(function(t) {
                                            if ("guid" === t.key)
                                                throw new R(
                                                    "Cannot pass `guid` from user space",
                                                    r
                                                );
                                            "insertBefore" === t.key &&
                                                (a = !0);
                                        });
                                        var n = I.literal("StringLiteral", t),
                                            i = I.pair("guid", n);
                                        if ((e.pairs.unshift(i), !a)) {
                                            var o = I.literal(
                                                ...
                                                s = I.pair("insertBefore", o);
                                            e.pairs.push(s);
                                        }
                                        return e;
                                    })(this.cursor(), n, t.loc));
                                var s = I.block(r, a, n, i, o, t.loc);
                                M(this.currentElement(), s);
                            } else
                                    ...
                                    case "tagName":
                                        throw new R(
                                            "Cannot use mustaches in an elements tagname: `"
                                                ...
                                                .concat(n.start.line, ":C")
                                                .concat(n.start.column),
                                            r.loc
                                        );
                                    case "beforeAttributeName":
                                        rt(this.currentStartTag, r);
                                        break;
                                    case "attributeName":
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            ...
                            if ("comment" === e.state)
                                return (
                                    this.appendToCommentData(
                                        this.sourceForNode(t)
                                    ),
                                    null
                                );
                            var r = t.value,
                                a = t.loc,
                                n = I.mustacheComment(r, a);
                            switch (e.state) {
                                case "beforeAttributeName":
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            ...
                            if (-1 !== r.indexOf("/")) {
                                ...
                                if ("." === r) {
                                    var n = "L"
                                        .concat(a.start.line, ":C")
                                        .concat(a.start.column);
                                    throw new R(
                                        "'.' is not a supported path in Glimmer; check for a path with a trailing '.' at ".concat(
                                            n,
                                            "."
                                        ),
                                        t.loc
                        ...
                        value: function(t) {
                            for (var e = [], r = 0; r < t.pairs.length; r++) {
                                ...
                                e.push(
                                    I.pair(
                                        a.key,
                                        this.acceptNode(a.value),
                                        a.loc
                                    )
                                );
                            }
                            return I.hash(e, t.loc);
                        }
                    },
                    {
                        key: "StringLiteral",
                        value: function(t) {
                            return I.literal("StringLiteral", t.value, t.loc);
                        }
                    },
                    {
                        key: "BooleanLiteral",
                        value: function(t) {
                            return I.literal("BooleanLiteral", t.value, t.loc);
                        }
                    },
                    {
                        key: "NumberLiteral",
                        value: function(t) {
                            return I.literal("NumberLiteral", t.value, t.loc);
                        }
                    },
                    {
                        key: "UndefinedLiteral",
                        value: function(t) {
                            return I.literal("UndefinedLiteral", void 0, t.loc);
                        }
                    },
                    {
                        key: "NullLiteral",
                        value: function(t) {
                            return I.literal("NullLiteral", null, t.loc);
                        }
                    },
                    {
                        key: "isTopLevel",
                        get: function() {
                            return 0 === this.elementStack.length;
                        }
                    }
                ]),
                e
    ...
    function et(t, e) {
        return {
            ...
            params: e.params
                ...
                : [],
            hash: e.hash ? t.Hash(e.hash) : I.hash()
        };
    }
    function rt(t, e) {
        var r = e.path,
        ...
        if (j(r)) {
            var o = "{{".concat(U(r), "}}"),
                s = "<".concat(t.name, " ... ").concat(o, " ...");
            throw new R(
                "In "
                    .concat(s, ", ")
                    .concat(o, ' is not a valid modifier: "')
                    .concat(r.original, '" on line ')
                    .concat(i && i.start.line, "."),
                e.loc
            );
        }
        var l = I.elementModifier(r, a, n, i);
        t.modifiers.push(l);
    }
    function at(t, e) {
    ...
    var nt = {
            ...
            Template: y("body"),
            Block: y("body"),
            MustacheStatement: y("path", "params", "hash"),
            BlockStatement: y("path", "params", "hash", "program", "inverse"),
            ElementModifierStatement: y("path", "params", "hash"),
            PartialStatement: y("name", "params", "hash"),
            CommentStatement: y(),
            MustacheCommentStatement: y(),
            ElementNode: y("attributes", "modifiers", "children", "comments"),
            AttrNode: y("value"),
            TextNode: y(),
            ConcatStatement: y("parts"),
            SubExpression: y("path", "params", "hash"),
            PathExpression: y(),
            StringLiteral: y(),
            BooleanLiteral: y(),
            NumberLiteral: y(),
    ...
    function ht(t, e) {
        var r,
            ...
            n,
            i = (function(t, e) {
                if (("Template" === e || "Block" === e) && t.Program)
                    return t.Program;
                var r = t[e];
                return void 0 !== r ? r : t.All;
            })(t, e.type);
        if (
            (void 0 !== i && ((r = ct(i)), (a = ut(i))),
            void 0 !== r && (n = r(e)),
            null != n)
        ) {
            if (JSON.stringify(e) !== JSON.stringify(n))
                return Array.isArray(n) ? (dt(t, n), n) : ht(t, n) || n;
            n = void 0;
        }
        if (void 0 === n) {
            for (var o = nt[e.type], s = 0; s < o.length; s++) {
                ft(t, i, e, o[s]);
            }
            void 0 !== a && (n = a(e));
        }
    ...
    function ft(t, e, r, a) {
        ...
        if (n) {
            ...
            if (void 0 !== e) {
                ...
                void 0 !== s && ((i = ct(s)), (o = ut(s)));
            }
            if (void 0 !== i && void 0 !== i(r, a)) throw lt(r, a);
            if (Array.isArray(n)) dt(t, n);
            else {
                var l = ht(t, n);
                void 0 !== l &&
                    (function(t, e, r, a) {
                        if (null === a) throw ot(r, t, e);
                        if (Array.isArray(a)) {
                            if (1 !== a.length)
                                throw 0 === a.length
                                    ? ot(r, t, e)
            ...
            if (void 0 !== o && void 0 !== o(r, a)) throw lt(r, a);
        }
    }
    function dt(t, e) {
        for (var r = 0; r < e.length; r++) {
            var a = ht(t, e[r]);
            void 0 !== a && (r += mt(e, r, a) - 1);
        }
    }
    function mt(t, e, r) {
        return null === r
            ? (t.splice(e, 1), 0)
            : Array.isArray(r)
            ? (t.splice.apply(t, [e, 1].concat(p(r))), r.length)
            : (t.splice(e, 1, r), 1);
    }
    function gt(t, e) {
        ht(e, t);
    ...
    var vt = /[\xA0"&]/,
        bt = new RegExp(vt.source, "g"),
        yt = /[\xA0&<>]/,
        kt = new RegExp(yt.source, "g");
    function St(t) {
    ...
    function xt(t) {
        return vt.test(t) ? t.replace(bt, St) : t;
    }
    function Et(t) {
        var e =
            arguments.length > 1 && void 0 !== arguments[1]
        ...
        function a(t) {
            ...
            return n([a, r(t.params).join(" "), Et(t.hash, e)], " ");
        }
        function n(t, e) {
            return (function(t) {
                var e = [];
        ...
        switch (t.type) {
            ...
            case "ElementNode":
                l.push("<", t.tag),
                    t.attributes.length &&
                        l.push(" ", r(t.attributes).join(" ")),
                    t.modifiers.length && l.push(" ", r(t.modifiers).join(" ")),
                    t.comments.length && l.push(" ", r(t.comments).join(" ")),
                    t.blockParams.length &&
                        l.push(
                            " ",
                            "as",
                            " ",
                            "|".concat(t.blockParams.join(" "), "|")
                        ),
                    ie[t.tag]
                        ? (t.selfClosing && l.push(" /"), l.push(">"))
                        : t.selfClosing
                        ? l.push(" />")
                        : (l.push(">"),
                          l.push.apply(l, r(t.children)),
                          l.push("</", t.tag, ">"));
                break;
            case "AttrNode":
                "TextNode" === t.value.type
                    ? "" !== t.value.chars
                        ? (l.push(t.name, "="),
                          l.push(
                              '"',
                              "raw" === e.entityEncoding
                                  ? t.value.chars
                                  : xt(t.value.chars),
                              '"'
                          ))
                        : l.push(t.name)
                    : (l.push(t.name, "="), l.push(Et(t.value, e)));
                break;
            ...
            case "TextNode":
                l.push(
                    "raw" === e.entityEncoding
                        ? t.chars
                        : ((s = t.chars), yt.test(s) ? s.replace(kt, wt) : s)
                );
                break;
            case "MustacheStatement":
                l.push(n(["{{", a(t), "}}"]));
            ...
            case "SubExpression":
                ...
                break;
            case "BooleanLiteral":
                l.push(t.value ? "true" : "false");
                break;
            case "BlockStatement":
                var h = [];
                t.chained
                    ? h.push(["{{else ", a(t), "}}"].join(""))
                    : h.push(["{{#", a((o = t)), i(o), "}}"].join("")),
                    h.push(Et(t.program, e)),
                    t.inverse &&
                        (t.inverse.chained || h.push("{{else}}"),
                        h.push(Et(t.inverse, e))),
                    t.chained ||
                        h.push(
                            (function(t) {
                                return ["{{/", Et(t.path, e), "}}"].join("");
                            })(t)
                        ),
                    l.push(h.join(""));
                break;
            ...
            case "CommentStatement":
                l.push(n(["\x3c!--", t.value, "--\x3e"]));
                break;
            case "StringLiteral":
                l.push('"'.concat(t.value, '"'));
                break;
            case "NumberLiteral":
                l.push(String(t.value));
                break;
            ...
            case "Hash":
                ...
                break;
            case "HashPair":
                l.push("".concat(t.key, "=").concat(Et(t.value, e)));
        }
        return l.join("");
    }
    var Pt = (function() {
            function t(e) {
                a(this, t), (this.order = e), (this.stack = []);
            }
            return (
                i(t, [
                    {
    ...
    var Lt = Nt(function(t, e) {
        ...
        c(/x/) &&
            (e.isFunction = c = function(t) {
                return (
                    "function" == typeof t && "[object Function]" === l.call(t)
                );
            }),
            (e.isFunction = c);
        var u =
            ...
            function(t) {
                return (
                    !(!t || "object" !== r(t)) && "[object Array]" === l.call(t)
                );
            };
        e.isArray = u;
    });
    ...
    Lt.extend,
        ...
        Lt.createFrame,
        Lt.blockParams,
        Lt.appendContextPath,
        Lt.isFunction,
        Lt.isArray;
    var Ct = Nt(function(t, e) {
        e.__esModule = !0;
        var r = [
            "description",
            "fileName",
        ...
        function a(t, e) {
            ...
            for (
                var s = Error.prototype.constructor.call(this, t), l = 0;
                l < r.length;
                l++
            )
                this[r[l]] = s[r[l]];
                ...
                t.registerHelper("blockHelperMissing", function(e, r) {
                    ...
                    if (Lt.isArray(e))
                        return e.length > 0
                            ...
                            : a(this);
                    if (r.data && r.ids) {
                        var i = Lt.createFrame(r.data);
                        (i.contextPath = Lt.appendContextPath(
                            r.data.contextPath,
                            r.name
                        )),
                            (r = { data: i });
    ...
    Tt(Dt);
    var qt = Nt(function(t, e) {
        e.__esModule = !0;
        var a,
            n = (a = Ct) && a.__esModule ? a : { default: a };
        (e.default = function(t) {
            t.registerHelper("each", function(t, e) {
                ...
                if (
                    (e.data &&
                        e.ids &&
                        (c =
                            Lt.appendContextPath(e.data.contextPath, e.ids[0]) +
                            "."),
                    Lt.isFunction(t) && (t = t.call(this)),
                    e.data && (l = Lt.createFrame(e.data)),
                    t && "object" === r(t))
                )
                    if (Lt.isArray(t))
                        for (var h = t.length; o < h; o++)
                            o in t && u(o, o, o === t.length - 1);
                    else if (_t.Symbol && t[_t.Symbol.iterator]) {
                        for (
                            var p = [],
                                f = t[_t.Symbol.iterator](),
                                d = f.next();
                            !d.done;
                            d = f.next()
                        )
                            p.push(d.value);
                        for (h = (t = p).length; o < h; o++)
                            u(o, o, o === t.length - 1);
                    } else {
                        var m = void 0;
                        for (var g in t)
                            t.hasOwnProperty(g) &&
                                (void 0 !== m && u(m, o - 1), (m = g), o++);
                        void 0 !== m && u(m, o - 1, !0);
                    }
    ...
    Tt(qt);
    var Ot = Nt(function(t, e) {
        e.__esModule = !0;
        var r,
            a = (r = Ct) && r.__esModule ? r : { default: r };
        (e.default = function(t) {
        ...
        (e.__esModule = !0),
            (e.default = function(t) {
                t.registerHelper("if", function(t, e) {
                    return (
                        Lt.isFunction(t) && (t = t.call(this)),
                        (!e.hash.includeZero && !t) || Lt.isEmpty(t)
                            ? e.inverse(this)
                            : e.fn(this)
                    );
                }),
    ...
    Tt(Rt);
    var Vt = Nt(function(t, e) {
        (e.__esModule = !0),
            (e.default = function(t) {
                t.registerHelper("with", function(t, e) {
                    Lt.isFunction(t) && (t = t.call(this));
                    var r = e.fn;
                    if (Lt.isEmpty(t)) return e.inverse(this);
                    var a = e.data;
                    return (
                        e.data &&
                            e.ids &&
                            ((a = Lt.createFrame(
                                e.data
                            )).contextPath = Lt.appendContextPath(
                                e.data.contextPath,
                                e.ids[0]
                            )),
                        r(t, {
    ...
    Tt(Ht);
    Ht.registerDefaultHelpers, Ht.moveHelperToHooks;
    var Mt = Nt(function(t, e) {
        (e.__esModule = !0),
            (e.default = function(t) {
                t.registerDecorator("inline", function(t, e, r, a) {
                    ...
                    return (
                        e.partials ||
                            ...
                            (n = function(a, n) {
                                var i = r.partials;
                                r.partials = Lt.extend({}, i, e.partials);
                                var o = t(a, n);
                                return (r.partials = i), o;
                            })),
    ...
    Tt(Mt);
    var jt = Nt(function(t, e) {
        (e.__esModule = !0),
            (e.registerDefaultDecorators = function(t) {
                a.default(t);
            });
        var r,
            a = (r = Mt) && r.__esModule ? r : { default: r };
    });
    Tt(jt);
    jt.registerDefaultDecorators;
    var Ut = Nt(function(t, e) {
        e.__esModule = !0;
        var r = {
            ...
            lookupLevel: function(t) {
                if ("string" == typeof t) {
                    var e = Lt.indexOf(r.methodMap, t.toLowerCase());
    ...
    var $t = Nt(function(t, e) {
        ...
        function i(t, e, r) {
            (this.helpers = t || {}),
                (this.partials = e || {}),
                (this.decorators = r || {}),
                Ht.registerDefaultHelpers(this),
                jt.registerDefaultDecorators(this);
        }
        i.prototype = {
            constructor: i,
            logger: n.default,
            ...
            registerHelper: function(t, e) {
                if ("[object Object]" === Lt.toString.call(t)) {
                    if (e)
                        throw new a.default(
                            "Arg not supported with multiple helpers"
                        );
                    Lt.extend(this.helpers, t);
        ...
        var o = n.default.log;
        (e.log = o), (e.createFrame = Lt.createFrame), (e.logger = n.default);
    });
    Tt($t);
    $t.HandlebarsEnvironment,
        $t.VERSION,
        $t.COMPILER_REVISION,
        $t.LAST_COMPATIBLE_COMPILER_REVISION,
        $t.REVISION_CHANGES,
        $t.log,
        $t.createFrame,
        $t.logger;
    var zt = Nt(function(t, e) {
        function r(t) {
            this.string = t;
        }
        (e.__esModule = !0),
    ...
    Tt(zt);
    var Ft = Nt(function(t, e) {
        (e.__esModule = !0),
            (e.checkRevision = function(t) {
                var e = (t && t[0]) || 1,
                    r = $t.COMPILER_REVISION;
                if (
                    e >= $t.LAST_COMPATIBLE_COMPILER_REVISION &&
                    e <= $t.COMPILER_REVISION
                )
                    return;
                if (e < $t.LAST_COMPATIBLE_COMPILER_REVISION) {
                    var a = $t.REVISION_CHANGES[r],
                        n = $t.REVISION_CHANGES[e];
                    throw new i.default(
            ...
            (e.template = function(t, e) {
                if (!e)
                    throw new i.default("No environment passed to template");
                if (!t || !t.main)
                    throw new i.default("Unknown template object: " + r(t));
                (t.main.decorator = t.main_d), e.VM.checkRevision(t.compiler);
                var a = t.compiler && 7 === t.compiler[0];
                var s = {
                    strict: function(t, e) {
                        if (!(e in t))
                            throw new i.default(
                    ...
                    invokePartial: function(r, a, o) {
                        o.hash &&
                            ((a = n.extend({}, a, o.hash)),
                            o.ids && (o.ids[0] = !0)),
                            (r = e.VM.resolvePartial.call(this, r, a, o));
                        var s = n.extend({}, o, { hooks: this.hooks }),
                            l = e.VM.invokePartial.call(this, r, a, s);
                        if (
                            (null == l &&
                                e.compile &&
                    ...
                    program: function(t, e, r, a, n) {
                        ...
                        return (
                            e || n || a || r
                                ? (i = o(this, t, s, e, r, a, n))
                                : i || (i = this.programs[t] = o(this, t, s)),
                            i
                        );
                    },
                    data: function(t, e) {
                ...
                function c(e) {
                    ...
                    c._setup(r),
                        !r.partial &&
                            ...
                            (a = (function(t, e) {
                                (e && "root" in e) ||
                                    ((e = e ? $t.createFrame(e) : {}).root = t);
                                return e;
                            })(e, a));
                    var n = void 0,
                        i = t.useBlockParams ? [] : void 0;
                    function o(e) {
                        return (
                            "" + t.main(s, e, s.helpers, s.partials, a, i, n)
                        );
                    }
                    return (
                        t.useDepths &&
                            (n = r.depths
                                ? e != r.depths[0]
                                    ...
                                    : r.depths
                                : [e]),
                        (o = l(t.main, o, s, r.depths || [], a, i))(e, r)
                    );
                }
                return (
                    (c.isTop = !0),
                    (c._setup = function(r) {
                        if (r.partial)
                            ...
                            (s.helpers = n.extend({}, e.helpers, r.helpers)),
                                t.usePartial &&
                                    (s.partials = n.extend(
                                        {},
                                        e.partials,
                                ...
                                (t.usePartial || t.useDecorators) &&
                                    (s.decorators = n.extend(
                                        {},
                                        e.decorators,
                                        r.decorators
                                    )),
                                (s.hooks = {});
                            var i = r.allowCallsToHelperMissing || a;
                            Ht.moveHelperToHooks(s, "helperMissing", i),
                                Ht.moveHelperToHooks(
                                    s,
                                    "blockHelperMissing",
                                    i
                                );
            ...
            (e.invokePartial = function(t, e, r) {
                ...
                r.fn &&
                    ...
                    (function() {
                        ...
                        var t = r.fn;
                        (o = r.data["partial-block"] = function(e) {
                            var r =
                                arguments.length <= 1 || void 0 === arguments[1]
                                    ? {}
                                    : arguments[1];
        ...
        var a,
            ...
            i = (a = Ct) && a.__esModule ? a : { default: a };
        function o(t, e, r, a, n, i, o) {
            function s(e) {
                var n =
                        arguments.length <= 1 || void 0 === arguments[1]
                            ? {}
        ...
        function l(t, e, r, a, i, o) {
            if (t.decorator) {
                var s = {};
                (e = t.decorator(e, s, r, a && a[0], i, o, a)), n.extend(e, s);
            }
            return e;
        }
    });
    ...
    Ft.checkRevision,
        ...
        Ft.invokePartial,
        Ft.noop;
    var Gt = Nt(function(t, e) {
        (e.__esModule = !0),
            (e.default = function(t) {
                var e = void 0 !== _t ? _t : window,
                    r = e.Handlebars;
    ...
    var Qt = Nt(function(t, e) {
        ...
        var r = (function() {
            var t = {
                    ...
                    performAction: function(t, e, r, a, n, i, o) {
                        var s = i.length - 1;
                        switch (n) {
                            case 1:
                                return i[s - 1];
                            case 2:
                                this.$ = a.prepareProgram(i[s]);
                                break;
                            case 3:
                            case 4:
                            case 5:
                            ...
                            case 9:
                                this.$ = {
                                    ...
                                    value: a.stripComment(i[s]),
                                    strip: a.stripFlags(i[s], i[s]),
                            ...
                            case 18:
                                this.$ = {
                                    strip: a.stripFlags(i[s - 1], i[s - 1]),
                                    program: i[s]
                                };
                                break;
                            case 19:
                                var l = a.prepareBlock(
                                        i[s - 2],
                                        i[s - 1],
                                        i[s],
                                        i[s],
                                    ...
                                    c = a.prepareProgram([l], i[s - 1].loc);
                                (c.chained = !0),
                                    (this.$ = {
                                        strip: i[s - 2].strip,
                                        program: c,
                            ...
                            case 41:
                                ...
                                break;
                            case 42:
                                this.$ = a.preparePath(!0, i[s], this._$);
                                break;
                            case 43:
                                this.$ = a.preparePath(!1, i[s], this._$);
                                break;
                            case 44:
                                i[s - 2].push({
                                    part: a.id(i[s]),
                                ...
                                break;
                            case 45:
                                this.$ = [{ part: a.id(i[s]), original: i[s] }];
                                break;
                            case 46:
                                this.$ = [];
                                break;
                                        ...
                                        (w._$ = {
                                            first_line:
                                                n[n.length - (b || 1)]
                                                    .first_line,
                                            last_line:
                                                n[n.length - 1].last_line,
                                            first_column:
                                                n[n.length - (b || 1)]
                                                    .first_column,
                                            last_column:
                                                n[n.length - 1].last_column
                                        }),
                                        h &&
                                            (w._$.range = [
        ...
        (n.prototype = {
            ...
            acceptRequired: function(t, e) {
                if ((this.acceptKey(t, e), !t[e]))
                    throw new a.default(t.type + " requires " + e);
            },
    ...
    Tt(Wt);
    var Yt = Nt(function(t, e) {
        e.__esModule = !0;
        var r,
            a = (r = Wt) && r.__esModule ? r : { default: r };
        function n() {
            var t =
                ...
                for (var a = t.body, n = 0, c = a.length; n < c; n++) {
                    ...
                    if (h) {
                        ...
                        h.close && s(a, n, !0),
                            ...
                            e &&
                                d &&
                                (s((u.program || u.inverse).body), l(a, n)),
                            e &&
                                m &&
                                (s(a, n), l((u.inverse || u.program).body));
                    }
                }
                return t;
            }),
    ...
    var Zt = Nt(function(t, e) {
        (e.__esModule = !0),
            ...
            (e.preparePath = function(t, e, r) {
                ...
                for (
                    ...
                    if (
                        ...
                        if (i.length > 0)
                            throw new a.default("Invalid path: " + n, {
                                loc: r
                            });
                        ".." === c && o++;
                    }
            ...
            (e.prepareBlock = function(t, e, r, i, o, s) {
                i && i.path && n(t, i);
                var l = /\*/.test(t.open);
    ...
    Zt.SourceLocation,
        ...
        Zt.prepareBlock,
        Zt.prepareProgram,
        Zt.preparePartialBlock;
    var Xt = Nt(function(t, e) {
        function r(t) {
            return t && t.__esModule ? t : { default: t };
        }
        (e.__esModule = !0),
            (e.parse = function(t, e) {
                ...
                return (
                    (a.default.yy = o),
                    (o.locInfo = function(t) {
                        return new o.SourceLocation(e && e.srcName, t);
                    }),
    ...
    var te = Nt(function(t, e) {
        ...
        (e.__esModule = !0),
            ...
            (e.compile = function(t, e, r) {
                ...
                "data" in (e = Lt.extend({}, e)) || (e.data = !0);
                e.compat && (e.useDepths = !0);
                var n = void 0;
                function i() {
                    var a = r.parse(t, e),
                        n = new r.Compiler().compile(a, e),
                        i = new r.JavaScriptCompiler().compile(
                            n,
                            e,
                            void 0,
                            !0
        ...
        function s(t, e) {
            if (t === e) return !0;
            if (Lt.isArray(t) && Lt.isArray(e) && t.length === e.length) {
        ...
        o.prototype = {
            ...
            equals: function(t) {
                ...
                for (var r = 0; r < e; r++) {
                    var a = this.opcodes[r],
                        n = t.opcodes[r];
                    if (a.opcode !== n.opcode || !s(a.args, n.args)) return !1;
                }
            ...
            compile: function(t, e) {
                ...
                if (
                    ...
                    for (var a in r) this.options.knownHelpers[a] = r[a];
            ...
            DecoratorBlock: function(t) {
                ...
                (this.useDecorators = !0),
                    this.opcode("registerDecorator", r.length, a.original);
            },
            PartialStatement: function(t) {
                ...
                this.options.preventIndent &&
                    ...
                    this.opcode("invokePartial", i, n, o),
                    this.opcode("append");
            },
            PartialBlockStatement: function(t) {
    ...
    Tt(te);
    te.Compiler, te.precompile, te.compile;
    var ee = Nt(function(t, e) {
        e.__esModule = !0;
        var r = void 0;
        try {
        ...
        r ||
            ((r = function(t, e, r, a) {
                ...
                add: function(t) {
                    Lt.isArray(t) && (t = t.join("")), (this.src += t);
                },
                prepend: function(t) {
                    Lt.isArray(t) && (t = t.join("")),
                        (this.src = t + this.src);
                },
    ...
    var re = Nt(function(t, e) {
        ...
        (o.prototype = {
            ...
            compilerInfo: function() {
                var t = $t.COMPILER_REVISION;
                return [t, $t.REVISION_CHANGES[t]];
            },
            ...
            compile: function(t, e, r, n) {
                ...
                for (l = 0, c = f.length; l < c; l++)
                    f[l] &&
                        ((h[l] = f[l]),
                        d[l] && ((h[l + "_d"] = d[l]), (h.useDecorators = !0)));
                return (
                    ...
                    n
                        ...
                        : ((h.compiler = JSON.stringify(h.compiler)),
                          ...
                          e.srcName
                              ? ((h = h.toStringWithSourceMap({
                                    file: e.destName
                                })).map = h.map && h.map.toString())
                              : (h = h.toString())),
                    h
                );
            },
                    ...
                    this.push(
                        (function(t, e, r, a) {
                            var n = e.popStack(),
                                ...
                                o = r.length;
                            t && o--;
                            for (; i < o; i++) n = e.nameLookup(n, r[i], a);
                            return t
                                ? [
            ...
            invokeHelper: function(t, e, r) {
                ...
                var o = ["(", this.itemsSeparatedBy(i, "||"), ")"],
                    s = this.source.functionCall(o, "call", n.callParams);
                this.push(s);
            },
            itemsSeparatedBy: function(t, e) {
                var r = [];
                r.push(t[0]);
                for (var a = 1; a < t.length; a++) r.push(e, t[a]);
                return r;
            },
            ...
            invokePartial: function(t, e, r) {
                ...
                t && ((e = this.popStack()), delete n.name),
                    ...
                    t
                        ? a.unshift(e)
                        : a.unshift(this.nameLookup("partials", e, "partial")),
            ...
            assignToHash: function(t) {
                ...
                this.trackIds && (n = this.popStack()),
                    this.stringParams &&
                        ((a = this.popStack()), (r = this.popStack()));
                var i = this.hash;
                r && (i.contexts[t] = r),
                    a && (i.types[t] = a),
                    n && (i.ids[t] = n),
            ...
            compileChildren: function(t, e) {
                for (
                    ...
                    var s = this.matchExistingProgram(a);
                    if (null == s) {
                        this.context.programs.push("");
                        var l = this.context.programs.length;
                        (a.index = l),
                            (a.name = "program" + l),
                            (this.context.programs[l] = n.compile(
                                a,
                                e,
                                this.context,
                                !this.precompile
            ...
            push: function(t) {
                return (
                    t instanceof i || (t = this.source.wrap(t)),
            ...
            replaceStack: function(t) {
                ...
                if (s instanceof i) (e = ["(", (r = [s.value])]), (o = !0);
                else {
                    n = !0;
            ...
            aliasable: function(t) {
                ...
                return e
                    ? (e.referenceCount++, e)
                    : (((e = this.aliases[t] = this.source.wrap(
                          t
                      )).aliasable = !0),
                      (e.referenceCount = 1),
                      e);
                ...
                for (var h = e; h--; )
                    (l = this.popStack()),
                        ...
                        this.stringParams &&
                            ...
                            (n[h] = this.popStack()));
                return (
                    s && (a.args = this.source.generateArray(r)),
                    this.trackIds && (a.ids = this.source.generateArray(o)),
                    this.stringParams &&
                        ((a.types = this.source.generateArray(i)),
                        (a.contexts = this.source.generateArray(n))),
            ...
            (o.isValidJavaScriptVariableName = function(t) {
                return (
                    !o.RESERVED_WORDS[t] && /^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(t)
                );
            }),
            (e.default = o),
            (t.exports = e.default);
        ...
        function c() {
            ...
            return (
                (t.compile = function(e, r) {
                    return te.compile(e, r, t);
                }),
                (t.precompile = function(e, r) {
                    return te.precompile(e, r, t);
                }),
                (t.AST = n.default),
                (t.Compiler = te.Compiler),
    ...
    var oe = (function(t) {
        function e() {
            ...
            return (
                a(this, e),
                ((t = c(this, s(e).apply(this, arguments))).tagOpenLine = 0),
                (t.tagOpenColumn = 0),
                t
            );
        }
        return (
            ...
            i(e, [
                ...
                },
                {
                    key: "finishComment",
                    value: function() {
                        (this.currentComment.loc.end = I.pos(
                            this.tokenizer.line,
                            this.tokenizer.column
                        )),
                            M(this.currentElement(), this.currentComment);
                    }
                },
                {
                    key: "beginData",
                    value: function() {
                        (this.currentNode = I.text()),
                            (this.currentNode.loc = {
                                source: null,
                                start: I.pos(
                                    this.tokenizer.line,
                ...
                },
                {
                    key: "finishData",
                    value: function() {
                        (this.currentData.loc.end = I.pos(
                            this.tokenizer.line,
                            this.tokenizer.column
                        )),
                            M(this.currentElement(), this.currentData);
                    }
                },
                {
                    key: "tagOpen",
                ...
                },
                {
                    ...
                    value: function() {
                        var t = this.currentStartTag,
                            ...
                            n = t.comments,
                            i = t.selfClosing,
                            o = I.loc(this.tagOpenLine, this.tagOpenColumn),
                            s = I.element(
                                { name: e, selfClosing: i },
                                { attrs: r, modifiers: a, comments: n, loc: o }
                            );
                        ...
                        !(function(t, e, r) {
                            ...
                            ie[t.name] && !r
                                ? (a =
                                      "Invalid end tag " +
                                      se(t) +
                                      " (void elements cannot have end tags).")
                                : void 0 === e.tag
                                ? (a =
                                      "Closing tag " +
                                      se(t) +
                        ...
                        if ("EndTag" === t.type)
                            throw new R(
                                "Invalid end tag: closing tag must not have attributes, " +
                                    "in `"
                                        .concat(t.name, "` (on line ")
                                        .concat(this.tokenizer.line, ")."),
                                t.loc
                            );
                                ...
                                if (r) {
                                        ...
                                        return (function(t) {
                                            for (var e = 0; e < t.length; e++) {
                                                ...
                                                if (
                                                    ...
                                                    throw new R(
                                                        "Unsupported node in quoted attribute value: " +
                                                            r.type,
                                                        r.loc
                                                    );
                                            }
                                    ...
                                    throw new R(
                                        "An unquoted attribute value must be a string or a mustache, preceeded by whitespace or a '=' character, and " +
                                            "followed by whitespace, a '>' character, or '/>' (on line ".concat(
                                                a,
                                                ")"
                                            ),
                                        I.loc(a, 0)
                    ...
                    value: function(t) {
                        throw new R(
                            "Syntax error at line "
                                ...
                                .concat(t),
                            I.loc(this.tokenizer.line, this.tokenizer.column)
                        );
                    }
                }
            ]),
    ...
    var le = { parse: ce, builders: I, print: Et, traverse: gt, Walker: Pt };
    function ce(t) {
        var e,
            a =
                arguments.length > 1 && void 0 !== arguments[1]
        ...
        if ("object" === r(t)) e = t;
            ...
            var i = a.parseOptions || {};
            "codemod" === n && (i.ignoreStandalone = !0), (e = ne(t, i));
        }
        var o = void 0;
        "codemod" === n && (o = new K({}));
        var s = new oe(t, o).acceptTemplate(e);
        if (a && a.plugins && a.plugins.ast)
            for (var l = 0, c = a.plugins.ast.length; l < c; l++) {
                gt(
                    s,
                    (0, a.plugins.ast[l])(
                        b({}, a, { syntax: le }, { plugins: void 0 })
                    ).visitor
                );
            }
        return s;
    }
    var ue = Object.freeze({ __proto__: null }),
        he = Object.freeze({
            __proto__: null,
            AST: ue,
            preprocess: ce,
            ...
            TraversalError: it,
            cannotRemoveNode: ot,
            cannotReplaceNode: st,
            cannotReplaceOrRemoveInKeyHandlerYet: lt,
            traverse: gt,
            Walker: Pt,
            print: Et,
            SyntaxError: R,
    ...
    var pe = {
            parsers: {
                glimmer: {
                    parse: function(t) {
                        try {
                            return (0, he.preprocess)(t, {
                                plugins: { ast: [] },
                                mode: "codemod"
                            });
                        } catch (t) {
                            var r = t.message.match(/on line (\d+)/);
                            throw r
                                ? e(t.message, {
                                      start: { line: Number(r[1]), column: 0 }
                                  })
                                : t;
                        }
                    },
