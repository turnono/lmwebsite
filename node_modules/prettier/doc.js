(function(global, factory) {
    ...
    var isFullwidthCodePoint = function isFullwidthCodePoint(codePoint) {
        ...
        if (
            ...
            (0x2e80 <= codePoint &&
                codePoint <= 0x3247 &&
                codePoint !== 0x303f) || // Enclosed CJK Letters and Months .. CJK Unified Ideographs Extension A
    ...
    function makeString(
        ...
        var newContent = rawContent.replace(regex, function(
            match,
            escaped,
            quote
        ) {
