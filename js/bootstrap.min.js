        ...
        l = (function() {
                                ...
                                if (o) {
                                    ...
                                    if (t) {
                                        if (
                                            ...
                                            return;
                                        (o.checked = !e(this._element).hasClass(
                                            i.ACTIVE
                                        )),
                                            e(o).trigger("change");
                                    }
            ...
            return (
                e(document)
                    ...
                    .on(o.FOCUS_BLUR_DATA_API, s.DATA_TOGGLE_CARROT, function(
                        t
                    ) {
                ...
                d = (function() {
                    ...
                    return (
                        ...
                        (d._getDimension = function() {
                            return e(this._element).hasClass(c.WIDTH)
                                ? c.WIDTH
                                : c.HEIGHT;
                        }),
        ...
        u = (function() {
                    ...
                    return (
                        ...
                        (a._clearMenus = function(t) {
                            if (
                                ...
                                for (
                                    var n = e.makeArray(e(u.DATA_TOGGLE)),
                                        s = 0;
                                    s < n.length;
                                    s++
                                ) {
            ...
            return (
                e(document)
                    ...
                    .on(
                        h.CLICK_DATA_API + " " + h.KEYUP_DATA_API,
                        g._clearMenus
                    )
                    ...
                    return (
                        ...
                        (u._resetScrollbar = function() {
                            e(c.FIXED_CONTENT).each(function(t, n) {
                                ...
                                e(
                                    c.STICKY_CONTENT + ", " + c.NAVBAR_TOGGLER
                                ).each(function(t, n) {
        ...
        g = (function() {
            ...
            return (
                e(window).on(a.LOAD_DATA_API, function() {
                    for (
                        var t = e.makeArray(e(h.DATA_SPY)), n = t.length;
                        n--;
                    ...
                    return (
                        (a.show = function() {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    r
                                        ? this._activate(r, r.parentNode, f)
                                        : f();
                                }
                            }
                        }),
                        ...
                        (a._transitionComplete = function(t, n, r, a) {
                            if (n) {
                                ...
                                var l = e(n.parentNode).find(
                                    o.DROPDOWN_ACTIVE_CHILD
                                )[0];
