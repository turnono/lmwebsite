...
var bootstrap = (function(t, e) {
    ...
    function b(t, e, n, i) {
        ...
        if ("viewport" === i) r = E(a);
            ...
            var l = void 0;
            "scrollParent" === i
                ? "BODY" === (l = s(o(t))).nodeName &&
                  (l = window.document.documentElement)
                : (l = "window" === i ? window.document.documentElement : i);
            var c = v(l, a);
    ...
    function N(t, e, n) {
        return (
            (void 0 === n ? t : t.slice(0, w(t, "name", n))).forEach(function(
                t
            ) {
                t.function &&
                    console.warn(
    ...
    function L() {
        if (!this.state.isDestroyed) {
            ...
            (t.offsets.reference = I(this.state, this.popper, this.reference)),
                (t.placement = A(
    ...
    function W(t, e, n, i) {
        ...
        var r = s(t);
        return (
            k(r, "scroll", n.updateBound, n.scrollParents),
            (n.scrollElement = r),
            (n.eventsEnabled = !0),
            n
        );
    ...
    for (
        var X = (function() {
                ...
                var o = !1,
                    ...
                    a = {
                        ...
                        getSelectorFromElement: function(t) {
                            ...
                            try {
                                return e(document).find(n).length > 0
                                    ? n
                                    : null;
                            } catch (t) {
                                return null;
                    ...
                    o = (function() {
                        ...
                        return (
                            ...
                            (n._removeElement = function(t) {
                                var n = this;
                                e(t).removeClass(r.SHOW),
                                    X.supportsTransitionEnd() &&
                                    e(t).hasClass(r.FADE)
                                        ? e(t)
            ...
            J = (function() {
                ...
                return (
                    e(document)
                        .on(o.CLICK_DATA_API, r.DATA_TOGGLE_CARROT, function(
                            t
                        ) {
                            t.preventDefault();
                            var n = t.target;
                            e(n).hasClass(i.BUTTON) ||
                                (n = e(n).closest(r.BUTTON)),
                                s._jQueryInterface.call(e(n), "toggle");
                        })
                        .on(
                            o.FOCUS_BLUR_DATA_API,
                            r.DATA_TOGGLE_CARROT,
                            function(t) {
                ...
                var t = "carousel",
                    ...
                    h = (function() {
                        ...
                        return (
                            ...
                            (h.pause = function(t) {
                                t || (this._isPaused = !0),
                                    e(this._element).find(f.NEXT_PREV)[0] &&
                                        X.supportsTransitionEnd() &&
                                        (X.triggerTransitionEnd(this._element),
                                        this.cycle(!0)),
                            ...
                            (h._triggerSlideEvent = function(t, n) {
                                var i = this._getItemIndex(t),
                                    r = this._getItemIndex(
                                        e(this._element).find(f.ACTIVE_ITEM)[0]
                                    ),
                                    o = e.Event(l.SLIDE, {
                                        relatedTarget: t,
                                        direction: n,
                            ...
                            (h._slide = function(t, n) {
                                var i,
                                    ...
                                    d =
                                        n ||
                                        (h && this._getItemByDirection(t, h)),
                                ...
                                if (
                                    ...
                                    X.supportsTransitionEnd() &&
                                    e(this._element).hasClass(c.SLIDE)
                                        ? (e(d).addClass(r),
                                          X.reflow(d),
                                          e(h).addClass(i),
                                          e(d).addClass(i),
                                        ...
                                        : (e(h).removeClass(c.ACTIVE),
                                          e(d).addClass(c.ACTIVE),
                                          (this._isSliding = !1),
            ...
            tt = (function() {
                var t = "collapse",
                    ...
                    f = (function() {
                        ...
                        return (
                            (f.toggle = function() {
                                e(this._element).hasClass(a.SHOW)
                                    ? this.hide()
                                    : this.show();
                            }),
                            (f.show = function() {
                            ...
                            (f._getConfig = function(n) {
                                return (
                                    ...
                                    X.typeCheckConfig(t, n, o),
                                    n
                                );
                            }),
                            (f._getDimension = function() {
                                return e(this._element).hasClass(l.WIDTH)
                                    ? l.WIDTH
                                    : l.HEIGHT;
                            }),
                ...
                return (
                    e(document).on(s.CLICK_DATA_API, c.DATA_TOGGLE, function(
                        t
                    ) {
            ...
            et = ["native code", "[object MutationObserverConstructor]"],
    ...
    var st =
        ...
        lt = function() {
            return (
                void 0 === at &&
                    (at = -1 !== navigator.appVersion.indexOf("MSIE 10")),
                at
            );
        },
        ct = function(t, e) {
            ...
            modifiers: {
                ...
                arrow: {
                    ...
                    fn: function(t, e) {
                        ...
                        var g = a[h] + a[c] / 2 - p / 2,
                            _ = r(t.instance.popper, "margin" + f).replace(
                                "px",
                                ""
                            ),
                            v = g - m(t.offsets.popper)[h] - _;
                        return (
                            (v = Math.max(Math.min(s[c] - p, v), 0)),
                            (t.arrowElement = n),
                            (t.offsets.arrow = {}),
                            (t.offsets.arrow[h] = Math.round(v)),
                            (t.offsets.arrow[u] = ""),
                            t
                        );
                    },
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        ...
                        if (
                            ((g =
                                "bottom" === h ? -l.height + f.bottom : f.top),
                            (p = "right" === u ? -l.width + f.right : f.left),
                            s && d)
                        )
                        ...
                        return (
                            (t.attributes = ut({}, E, t.attributes)),
                            (t.styles = ut({}, c, t.styles)),
                            (t.arrowStyles = ut(
                                {},
                                t.offsets.arrow,
                                t.arrowStyles
        ...
        _t = (function() {
            function t(e, n) {
                ...
                ct(this, t),
                    ...
                    (this.update = st(this.update.bind(this))),
                    ...
                    Object.keys(
                        ut({}, t.Defaults.modifiers, o.modifiers)
                    ).forEach(function(e) {
                        r.options.modifiers[e] = ut(
                            {},
    ...
    (_t.Utils = ("undefined" != typeof window ? window : global).PopperUtils),
        (_t.placements = dt),
        (_t.Defaults = mt);
    var vt = (function() {
            if ("undefined" == typeof _t)
                throw new Error(
                    ...
                    return (
                                ...
                                if ((r._clearMenus(), !n)) {
                                    ...
                                    if (
                                        ...
                                        e(t).hasClass(a.DROPUP) &&
                                            ...
                                            e(this._menu).toggleClass(a.SHOW),
                                            e(t)
                                                .toggleClass(a.SHOW)
                                                .trigger(e.Event(s.SHOWN, i));
                                    }
                                }
                            }
                        }),
                        ...
                        (u._getPlacement = function() {
                            ...
                            return (
                                t.hasClass(a.DROPUP)
                                    ? ((n = c.TOP),
                                      e(this._menu).hasClass(a.MENURIGHT) &&
                                          (n = c.TOPEND))
                                    : e(this._menu).hasClass(a.MENURIGHT) &&
                                      (n = c.BOTTOMEND),
                                n
                        ...
                        (r._clearMenus = function(t) {
                            if (
                                ...
                                for (
                                    var i = e.makeArray(e(l.DATA_TOGGLE)),
                                        o = 0;
                                    o < i.length;
                                    o++
                                ) {
            ...
            return (
                e(document)
                    .on(
                        s.KEYDOWN_DATA_API,
                        l.DATA_TOGGLE,
                        u._dataApiKeydownHandler
                    )
                    .on(s.KEYDOWN_DATA_API, l.MENU, u._dataApiKeydownHandler)
                    .on(
                        s.CLICK_DATA_API + " " + s.KEYUP_DATA_API,
                        u._clearMenus
                    )
                    .on(s.CLICK_DATA_API, l.DATA_TOGGLE, function(t) {
                        t.preventDefault(),
                            t.stopPropagation(),
                            u._jQueryInterface.call(e(this), "toggle");
                    })
        ...
        Et = (function() {
            var t = "modal",
                ...
                c = (function() {
                    function i(t, n) {
                        (this._config = this._getConfig(n)),
                            (this._element = t),
                            (this._dialog = e(t).find(l.DIALOG)[0]),
                            (this._backdrop = null),
                            (this._isShown = !1),
                    ...
                    return (
                        ...
                        (c.show = function(t) {
                            ...
                            if (!this._isTransitioning && !this._isShown) {
                                X.supportsTransitionEnd() &&
                                    e(this._element).hasClass(a.FADE) &&
                                    (this._isTransitioning = !0);
                                var i = e.Event(s.SHOW, { relatedTarget: t });
                                e(this._element).trigger(i),
                                    this._isShown ||
                                        ...
                                        this._setScrollbar(),
                                        this._adjustDialog(),
                                        e(document.body).addClass(a.OPEN),
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    r && (this._isTransitioning = !0),
                                        this._setEscapeEvent(),
                                        this._setResizeEvent(),
                                        e(document).off(s.FOCUSIN),
                                        e(this._element).removeClass(a.SHOW),
                        ...
                        (c._showElement = function(t) {
                            ...
                            (this._element.parentNode &&
                                ...
                                e(this._element).addClass(a.SHOW),
                                this._config.focus && this._enforceFocus();
                            var r = e.Event(s.SHOWN, { relatedTarget: t }),
                                o = function() {
                        ...
                        (c._setEscapeEvent = function() {
                            ...
                            this._isShown && this._config.keyboard
                                ...
                                : this._isShown ||
                                  e(this._element).off(s.KEYDOWN_DISMISS);
                        }),
                        (c._setResizeEvent = function() {
                            var t = this;
                            this._isShown
                                ? e(window).on(s.RESIZE, function(e) {
                        ...
                        (c._hideModal = function() {
                            ...
                            (this._element.style.display = "none"),
                                ...
                                (this._isTransitioning = !1),
                                this._showBackdrop(function() {
                                    e(document.body).removeClass(a.OPEN),
                                        t._resetAdjustments(),
                                        t._resetScrollbar(),
                                        e(t._element).trigger(s.HIDDEN);
                                });
                        }),
                        ...
                        (c._showBackdrop = function(t) {
                            var n = this,
                                i = e(this._element).hasClass(a.FADE)
                                    ? a.FADE
                                    : "";
                            if (this._isShown && this._config.backdrop) {
                                ...
                                if (
                                    ...
                                    r && X.reflow(this._backdrop),
                                    e(this._backdrop).addClass(a.SHOW),
                                    !t)
                                )
                                    return;
                                if (!r) return void t();
                        ...
                        (c._resetScrollbar = function() {
                            e(l.FIXED_CONTENT).each(function(t, n) {
                                ...
                                e(
                                    l.STICKY_CONTENT + ", " + l.NAVBAR_TOGGLER
                                ).each(function(t, n) {
                        ...
                        (c._getScrollbarWidth = function() {
                            ...
                            (t.className = a.SCROLLBAR_MEASURER),
            ...
            return (
                e(document).on(s.CLICK_DATA_API, l.DATA_TOGGLE, function(t) {
                    var n,
                        i = this,
                        r = X.getSelectorFromElement(this);
                    r && (n = e(r)[0]);
                    ...
                    return (
                        ...
                        (d.toggle = function(t) {
                            if (this._isEnabled)
                                if (t) {
                                    ...
                                    if (
                                        e(this.getTipElement()).hasClass(f.SHOW)
                                    )
                        ...
                        (d.show = function() {
                            ...
                            if (this.isWithContent() && this._isEnabled) {
                                ...
                                e(o).data(this.constructor.DATA_KEY, this),
                                    ...
                                    (this._popper = new _t(this.element, o, {
                                        placement: c,
                                        modifiers: {
                                            offset: {
                                ...
                                var d = function() {
                                    ...
                                    (t._hoverState = null),
                                        ...
                                        n === l.OUT && t._leave(null, t);
                                };
                                X.supportsTransitionEnd() &&
                                e(this.tip).hasClass(f.FADE)
                                    ? e(this.tip)
                                          .one(X.TRANSITION_END, d)
                                          .emulateTransitionEnd(
                                              i._TRANSITION_DURATION
                                          )
                                    : d();
                            }
                        }),
                        ...
                        (d._enter = function(t, n) {
                            ...
                            (n = n || e(t.currentTarget).data(i)) ||
                                ...
                                t &&
                                    (n._activeTrigger[
                                        "focusin" === t.type ? u.FOCUS : u.HOVER
                                    ] = !0),
        ...
        Ct = (function() {
                ...
                c = (function() {
                    function n(t, n) {
                        ...
                        (this._element = t),
                            ...
                            e(this._scrollElement).on(o.SCROLL, function(t) {
                                return i._process(t);
                            }),
                            this.refresh(),
                            this._process();
            ...
            return (
                e(window).on(o.LOAD_DATA_API, function() {
                    for (
                        var t = e.makeArray(e(a.DATA_SPY)), n = t.length;
                        n--;
        ...
        At = (function() {
                    ...
                    return (
                        (o.show = function() {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    o
                                        ? this._activate(o, o.parentNode, u)
                                        : u();
                                }
                            }
                        }),
                        ...
                        (o._activate = function(t, n, o) {
                            var s,
                                ...
                                l = (s =
                                    "UL" === n.nodeName
                                        ? e(n).find(r.ACTIVE_UL)
                                        : e(n).children(r.ACTIVE))[0],
                                c =
                                    o &&
                                    X.supportsTransitionEnd() &&
                                    l &&
                            ...
                            l && c
                                ? e(l)
                                      .one(X.TRANSITION_END, f)
                                      .emulateTransitionEnd(150)
                                : f(),
                                l && e(l).removeClass(i.SHOW);
                        }),
                        (o._transitionComplete = function(t, n, o, s) {
                            if (n) {
                                e(n).removeClass(i.ACTIVE);
                                var a = e(n.parentNode).find(
                                    r.DROPDOWN_ACTIVE_CHILD
                                )[0];
                                a && e(a).removeClass(i.ACTIVE),
                            ...
                            if (
                                ...
                                o
                                    ? (X.reflow(t), e(t).addClass(i.SHOW))
                                    : e(t).removeClass(i.FADE),
                                t.parentNode &&
                                    e(t.parentNode).hasClass(i.DROPDOWN_MENU))
                            ) {
                                var l = e(t).closest(r.DROPDOWN)[0];
                                l &&
                                    e(l)
                                        .find(r.DROPDOWN_TOGGLE)
                                        .addClass(i.ACTIVE),
            ...
            return (
                e(document).on(n.CLICK_DATA_API, r.DATA_TOGGLE, function(t) {
                    t.preventDefault(),
                        o._jQueryInterface.call(e(this), "show");
                }),
                (e.fn.tab = o._jQueryInterface),
                (e.fn.tab.Constructor = o),
